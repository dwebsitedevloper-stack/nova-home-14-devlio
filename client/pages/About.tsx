        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg">
            <p className="text-lg text-foreground mb-6">
              This page is ready to be customized! Continue prompting me to add detailed information about NatureGym's mission, history, values, and commitment to sustainability and wellness.
            </p>
            <div className="flex gap-4 justify-center">
              ...
              <button
                onClick={() => {
                  const userMessage = "Please add detailed About content to the About page, including company history, mission, values, and commitment to sustainability.";
