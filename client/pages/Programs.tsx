        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg">
            <p className="text-lg text-foreground mb-6">
              This page is ready to be customized! Continue prompting me to add detailed workout programs, class schedules, difficulty levels, and specialized training tracks.
            </p>
            <div className="flex gap-4 justify-center">
              ...
              <button
                onClick={() => {
                  const userMessage = "Please add detailed Programs content including class schedules, difficulty levels, program descriptions, and fitness tracks.";
